...
# from selenium.webdriver.support import expected_conditions as EC
 ...
 #        w = GoogleImageExtractor(prod1.name)  # leave blanks if get the search list from file
 #        # searchlist_filename = r'C:\data\temp\gimage_pic\imgsearch_list.txt'
 #        w.set_num_image_to_dl(5)
...
#
#         ## user options
#         self.image_dl_per_search = 50
#
#         ## url construct string text
#         self.prefix_of_search_url = "https://www.google.com/search?q="
...
#         self.folder_main_dir_prefix = '/tmp/aaaaa'
#
